...
public class FleetMenu extends JPanel {
    ...
    private void sizeUpdate() {
        gridPanel1.setPreferredSize(new Dimension((int) (getWindow().getWidth()*0.17), (int) (getWindow().getHeight()*(0.12* (gridPanel1.getComponentCount())))));
        gridPanel2.setPreferredSize(new Dimension((int) (getWindow().getWidth()*0.17), (int) (getWindow().getHeight()*(0.12* (gridPanel2.getComponentCount())))));
        gridPanel3.setPreferredSize(new Dimension((int) (getWindow().getWidth()*0.17), (int) (getWindow().getHeight()*(0.12* (gridPanel3.getComponentCount())))));
