...
//            for(int k=0; k<40; k++){
//                boats.add(new Military("military1", "blue", new GraphPoint(new Point(-100, -100), null)));
//            }
//
...
//
//            if(A != null){
//                for(Boat boat : A.getFleet().getArrayListBoat()){
//                    painter.paint(boat, g2d);
//                }
//            }
//            if(B != null){
//                for(Boat boat : B.getFleet().getArrayListBoat()){
//                    painter.paint(boat,g2d);
//                }
//            }
//
